...
interface ThankYouContentProps {
    formType?: 'seller' | 'buyer' | 'general';
}

export function ThankYouContent({ formType = 'general' }: ThankYouContentProps) {
    ...
    const getFormLink = () => {
        switch (formType) {
            case 'seller':
                return '/landing-forms/seller';
            case 'buyer':
                return '/landing-forms/buyer';
            default:
                return '/landing/enlgish-form';
        }
    };
    ...
    const getFormLabel = () => {
        switch (formType) {
            case 'seller':
                return 'Sell Property Form';
            case 'buyer':
                return 'Buy Property Form';
            default:
                return 'Contact Form';
        }
    };
            ...
            <div className="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-lg text-center">
                ...
                <div className="space-y-4 mb-8">
                    <h2 className="text-xl text-gray-700">
                        Your {formType === 'seller' ? 'property selling' : formType === 'buyer' ? 'property buying' : 'consultation'} request has been submitted successfully.
                    </h2>
                ...
                <div className="border-t pt-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-gray-600">
                        ...
                        <div className="space-y-2">
                            ...
                            <p>We match you with the right {formType === 'seller' ? 'property specialist' : 'consultant'}</p>
                        </div>
                        <div className="space-y-2">
