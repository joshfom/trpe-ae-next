...
function LuxeFooter({showAbout = true}: LuxeFooterProps) {
    ...
    return (
        <div className={'w-full  pb-16 lg:pb-0 border-zinc-500'}>

            <div className={'py-12'}>
                <div className="max-w-7xl mx-auto border-t px-2 lg:px-0 pb-12 lg:p-6">
              <div className={' flex flex-col lg:flex-row justify-end py-12'}>
                    ...
                    <div
                        className=" py-5 lg:py-12 grid md:grid-cols-1 lg:grid-cols-3 gap-6">
                        <div className="space-y-6">
                            <div>
                                ...
                                <div className="flex flex-col pt-2">
                                    <Link
                                        className={'px-4 py-2 border-b border-transparent hover:border-slate-700'}
                ...
                <div className="max-w-7xl mx-auto lg:p-2 flex gap-8 items-center">
                    <div className="">
                    ...
                    <div className="flex flex-col lg:flex-row gap-4">
                        ...
                        <Link className={'pb-1 border-b'} href={'/cookie-policy'}>Cookie Policy</Link>
                    </div>
                </div>
