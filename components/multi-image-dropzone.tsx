...
import {Camera, ImageUp, UploadCloudIcon, X} from 'lucide-react';
    ...
    (
        ...
        return (
            <div className="w-full space-y-4">
                ...
                <div
                    className="grid grid-cols-[repeat(1,1fr)] mt-4 gap-2 sm:grid-cols-[repeat(2,1fr)] lg:grid-cols-[repeat(3,1fr)] xl:grid-cols-[repeat(4,1fr)]">
                    {/* Images */}
                    {value?.map(({file, progress}, index) => (
                        <div
                            key={index}
