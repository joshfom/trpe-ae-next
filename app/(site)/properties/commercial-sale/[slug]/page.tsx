...
const getProperty = unstable_cache(
    ...
    ['property-detail-commercial-sale'],
    {
        revalidate: 3600, // 1 hour cache for property details
        tags: ['properties', 'property-details', 'commercial-sale']
    }
);
...
const getSimilarProperties = unstable_cache(
    ...
    ['similar-properties-commercial-sale'],
    {
        revalidate: 1800, // 30 minutes cache for similar properties
        tags: ['properties', 'similar-properties', 'commercial-sale']
    }
);

// Generate static params for most popular commercial sale properties
