...
import PropertyPageSearchFilterWrapper from '@/components/PropertyPageSearchFilterWrapper';
...
async function PropertyForSalePage({searchParams}: Props) {
    ...
    // Set default page title for all properties
    let pageTitle = "All Properties in Dubai";

    // Override with pageMeta title if available
    if (pageMeta?.title) {
    ...
    return (
        <div className={' bg-slate-100'}>
            ...
            <PropertyPageSearchFilterWrapper />
