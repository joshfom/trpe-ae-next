...
export async function generateMetadata(props: Props, parent: ResolvingMetadata): Promise<Metadata> {
    ...
    const pathname = `/dubai/properties/residential/for-sale/${slug}`;
    ...
    if (pageMeta?.metaTitle) {
        return {
            ...
            alternates: {
                canonical: `${process.env.NEXT_PUBLIC_URL}/dubai/properties/residential/for-sale/${slug}`,
            },
            robots: {
