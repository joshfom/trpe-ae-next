...
export async function generateMetadata(props: Props, parent: ResolvingMetadata): Promise<Metadata> {
    ...
    const pathname = `/dubai/properties/commercial/for-rent/${slug}/${subSlug}`;
    ...
    if (pageMeta?.metaTitle) {
        return {
            ...
            alternates: {
                canonical: `${process.env.NEXT_PUBLIC_URL}/dubai/properties/commercial/for-rent/${slug}/${subSlug}`,
            },
            robots: {
