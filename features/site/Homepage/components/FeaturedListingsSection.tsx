...
function FeaturedListingsSection({saleListings, rentalListings}: FeaturedListingsSectionProps) {
                        ...
                        <div>
                            ...
                            <div className="py-6 flex items-center mt-8 justify-center">
                                <Link href={'/properties/for-sale'}
                                      className={'bg-slate-900 rounded-full lg:px-8 py-2 border  text-white hover:bg-white hover:text-slate-600 px-6'}>
