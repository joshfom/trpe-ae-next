...
/**
 * Custom hook for uploading images to an offplan
...
export const useUploadOffplanImages = (offplanId: string) => {
    ...
    const mutate = async (imageData: RequestType, options?: {
        ...
        try {
            ...
            const result = await uploadOffplanImages(offplanId, imageData);
