...
function MainSearchServer({ mode = 'general' }: MainSearchServerProps) {
    ...
    try {
        ...
        console.error('Error in MainSearchServer:', error);
        // Return a fallback search UI
        return (
            <div className="w-full lg:w-[70%] max-w-4xl mx-auto">
                <div className="relative">
                    <div className="flex gap-6 bg-white rounded-full shadow-lg p-3 pl-8 items-center">
